...
export const FormsControl: React.FC<WrappedFieldsProps> = ({input,meta, ...restProps}) => {
    const classStyle = meta.touched && meta.error ? s.errorTextarea + ' ' + s.textarea :  s.textarea
    return <div >
        <textarea className={classStyle} {...restProps} {...input}{...meta}/>
        <div>
...
export const Textarea: React.FC<WrappedFieldsProps> = ({input,meta, ...restProps}) => {
    const classStyle = meta.touched && meta.error ? s.errorTextarea + ' ' + s.textarea :  s.textarea
    return <div >
        <textarea className={classStyle} {...restProps} {...input}{...meta}/>
        <div>
